        ...
        <div className={classes.headerContainer}>
          ...
          <div className={classes.textContainer}>
            ...
            <p className={classes.subheading}>
              CORGIB Finance is a fully decentralized, the first NFT MarketPlace
              for Meme tokens, powered by{" "}
              <strong className={classes.highlight}>PolkaBridge</strong>.
            </p>
            <div className={classes.buttons}>
              {/* <div className={classes.pancakeSwap}></div>
              <div className={classes.joinStake}></div> */}
              <CustomButton
                title={"PancakeSwap"}
                link={
